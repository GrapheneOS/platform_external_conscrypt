...
# Remove non-needed annotations:
rm ${REPACKAGED_DIR}/openjdk/src/main/java/dalvik/annotation/optimization/FastNative.java
rm ${REPACKAGED_DIR}/openjdk/src/main/java/dalvik/annotation/optimization/CriticalNative.java
