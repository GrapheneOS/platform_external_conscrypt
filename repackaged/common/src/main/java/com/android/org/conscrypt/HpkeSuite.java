...
public final class HpkeSuite {
    ...
    enum KEM {
         ...
         * @see <a
         *         href="https://www.rfc-editor.org/rfc/rfc9180.html#name-key-encapsulation-mechanism">
         *     expected enc size</a>
         */
        void validateEncapsulatedLength(byte[] encapsulated) throws InvalidKeyException {
            ...
            if (encapsulated.length != expectedLength) {
                throw new InvalidKeyException("Expected encapsulated length of " + expectedLength
                        + ", but was " + encapsulated.length);
            }
        }
