...
public final class CipherTest {
    ...
    public void aesGcmWithEqualBuffers() throws Exception {
        ...
        int ctLength = cipher.doFinal(plainWithPadding, offset, length, plainWithPadding, offset + 8);
    ...
    public void aesGcmWithIdenticalBuffers_ExactOverlap() throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, skeySpec, ivSpec);
        cipher.updateAAD(associatedData);
        int actualCiphertextLength = cipher.doFinal(sharedBuffer, inputOffset, plaintextLength, sharedBuffer, outputOffset);
    ...
    public void aesGcmWithIdenticalBuffers_BackwardOverlap() throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, skeySpec, ivSpec);
        cipher.updateAAD(associatedData);
        int actualCiphertextLength = cipher.doFinal(sharedBuffer, inputStartOffset, plaintextLength, sharedBuffer, outputStartOffset);
    ...
    public void aesGcmWithIdenticalBuffers_BackwardOverlap_OutputTooSmallForTag() throws Exception {
        ...
        int totalBufferSize = inputStartOffset + plaintextLength + (tagLength / 2); // Deliberately too small
        ...
        try {
            cipher.doFinal(sharedBuffer, inputStartOffset, plaintextLength, sharedBuffer, outputStartOffset);
    ...
    public void aesGcmWithIdenticalBuffers_ForwardOverlap_OutputTooSmallForTag() throws Exception {
        ...
        // Total buffer size is input start + plaintext length + output offset + a portion of the tag,
        // making it too small at the end.
        int totalBufferSize = outputStartOffset + plaintextLength + (tagLength / 2); // Deliberately too small
